...
3.  **Reporting**: Generate a technical security report and ALWAYS save it as a `.md` file inside the `.agents/skills/avaliacoes` directory with a descriptive name (e.g., `audit_[skill_name].md`).
